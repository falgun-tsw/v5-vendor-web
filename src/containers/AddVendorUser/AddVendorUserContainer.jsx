...
class AddVendorUserContainer extends Component {
  constructor(props) {
    super(props);
    this.state = {
      form: {
  ...
  handleSubmit = async () => {
    ...
    try {
      const response = await manageVendorUserApi.addVendorUser(payload);
      if (response) {
        this.props.setToast({ message: "Vendor User Added Successfully" });
...
export default AddVendorUserContainer;
