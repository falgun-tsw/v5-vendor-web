...
class JobDetailsContainer extends Component {
  ...
  handleApplyJob = async () => {
    ...
    try {
      const response = await jobManagementApis.applyJob({id, userNote});
      if(response){
        this.props.setToast({ message: response.message })
      }
    } catch (e) {
      console.log("error", e);
    } finally {
  ...
  render() {
    ...
    const { jobdetailLoading, jobDetails } = this.props;
    const {
      jobTitle,
      jobRefNo,
      jobShortDescription,
    ...
    const jobTimingData = {
      ...
      data: [
        ...
        {
          label: "Shift time -",
          value: `${jobTiming.shiftStartTime} - ${jobTiming.shiftEndTime}`,
        },
        {
          label: "Job days -",
        ...
        >
          ...
          >
            ...
            <Stack direction="row" spacing={2} mt={3} sx={{ width: { xs: "100%", sm: "100%", md: "50%" }}}>
              {jobApplicantStatus === constants.NEW.value ? (
                <Button
                  variant="contained"
                  sx={{
                    borderRadius: "0.5rem",
                  ...
                  onClick={this.toggleApplyJobModal}
                  loading={isLoading}
                >
                  Unapply
                </Button>
          ...
          >
            <Stack component="form" method="post">
              ...
              >
                ...
                {jobApplicantStatus === null ? "apply" : "unapply"} on this job?
              </Text>
              <TextField
                sx={{ marginTop: "1rem" }}
                multiline
              ...
              <Stack direction="row" spacing={2} justifyContent="center" mt={3}>
                ...
                <Button
                  ...
                  sx={{ width: "10rem" }}
                >
                  {jobApplicantStatus === null ? "Apply" : "Unapply"}
                </Button>
              </Stack>
            </Stack>
          </Modal>
