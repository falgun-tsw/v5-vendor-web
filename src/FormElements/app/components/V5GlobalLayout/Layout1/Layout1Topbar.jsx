...
import { V5GlobalMenu, V5GlobalSearchBox } from 'src/FormElements/app/components'
import { useDispatch, useSelector } from 'react-redux';
import NotificationBar from '../../NotificationBar/NotificationBar'
import { themeShadows } from 'src/FormElements/app/components/V5GlobalTheme/themeColors'
import { NotificationProvider } from 'src/FormElements/app/contexts/NotificationContext'
...
import { topBarHeight } from 'src/FormElements/app/utilities/constant'

import Modal from '@mui/material/Modal';
import Visibility from '@mui/icons-material/Visibility'
import VisibilityOff from '@mui/icons-material/VisibilityOff'
import ConfirmPassword from './ChangePassword';
import ConfirmationDialog from 'src/FormElements/app/components/ConfirmationDialog/ConfirmationDialog';
import { V5GlobalLogo } from 'src/FormElements/app/components';
...
const Layout1Topbar = () => {
    ...
    const { userProfileLogo, profileId, userProfileDetails } = useSelector((state) => state.screenBuilder.profile);
